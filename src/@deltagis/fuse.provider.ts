...
import {
    ...
    mockApiInterceptor,
} from '@deltagis/lib/mock-api';
import { FuseConfig } from '@deltagis/services/config';
import { FUSE_CONFIG } from '@deltagis/services/config/config.constants';
import { FuseConfirmationService } from '@deltagis/services/confirmation';
import {
    FuseLoadingService,
    fuseLoadingInterceptor,
} from '@deltagis/services/loading';
...
import { FuseSplashScreenService } from '@deltagis/services/splash-screen';
import { FuseUtilsService } from '@deltagis/services/utils';
