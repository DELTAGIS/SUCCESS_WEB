...
import { FuseNavigationService } from '@deltagis/components/navigation/navigation.service';
import {
    FuseNavigationItem,
    FuseVerticalNavigationAppearance,
    FuseVerticalNavigationMode,
    FuseVerticalNavigationPosition,
} from '@deltagis/components/navigation/navigation.types';
import { FuseVerticalNavigationAsideItemComponent } from '@deltagis/components/navigation/vertical/components/aside/aside.component';
import { FuseVerticalNavigationBasicItemComponent } from '@deltagis/components/navigation/vertical/components/basic/basic.component';
import { FuseVerticalNavigationCollapsableItemComponent } from '@deltagis/components/navigation/vertical/components/collapsable/collapsable.component';
import { FuseVerticalNavigationDividerItemComponent } from '@deltagis/components/navigation/vertical/components/divider/divider.component';
import { FuseVerticalNavigationGroupItemComponent } from '@deltagis/components/navigation/vertical/components/group/group.component';
import { FuseVerticalNavigationSpacerItemComponent } from '@deltagis/components/navigation/vertical/components/spacer/spacer.component';
import { FuseScrollbarDirective } from '@deltagis/directives/scrollbar/scrollbar.directive';
import { FuseUtilsService } from '@deltagis/services/utils/utils.service';
import {
    delay,
    filter,
    merge,
